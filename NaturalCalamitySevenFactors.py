...
print "target list", y
feature_list=[]
for a,b,c,d,e,f,g in modified_weather_df[["AirPressure","WindSpeed", "Moisture" ,"Moisure Density","Snow","Hail Size", "Dust Size"]].itertuples(index=False):
    feature_list.append([a,b,c, d,e,f, g])
